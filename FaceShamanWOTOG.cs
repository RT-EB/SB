...
namespace SmartBotProfiles
{
    ...
    public class ShamanFace : Profile
    {
        ...
        private readonly Dictionary<Card.Cards, int> _minionsOverloadTable = new Dictionary<Card.Cards, int>
        {
            ...
            {Cards.FlamewreathedFaceless, CardTemplate.TemplateList[Cards.FlamewreathedFaceless].Overload}
        };
        ...
        public ProfileParameters GetParameters(Board board)
        {
            ...
            //Set lava shock spell and eternal sentinel minion modifier to 200% of the base spell/minion value defined in "Rush" profile, the bot will try to keep this spell in hand without any overloaded mana
            parameters.SpellsModifiers.AddOrUpdate(Cards.LavaShock, new Modifier(200));
            parameters.MinionsModifiers.AddOrUpdate(Cards.EternalSentinel, new Modifier(200));
